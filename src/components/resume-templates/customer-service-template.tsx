...
export const CustomerServiceTemplate: React.FC<TemplateProps> = ({ data, accentColor: accentColorProp }) => {
  ...
  return (
    <div className="bg-white text-[var(--fs-body)] w-full h-full flex" style={{ fontFamily: "'Karla', sans-serif" }}>
