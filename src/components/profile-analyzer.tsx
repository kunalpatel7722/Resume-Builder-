  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!profileData) {
      toast({
        ...
        description: "Please upload a PDF or enter a URL to analyze.",
        variant: "destructive",
      });
      return;
    }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
        <Card className="shadow-lg sticky top-8">
          <CardHeader>
            ...
            <CardDescription>Upload your profile as a PDF or provide a public URL.</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                ...
                <TabsContent value="url" className="mt-4">
                   <div className="space-y-2">
                    <label htmlFor="url-input" className="text-sm font-medium">LinkedIn Profile URL</label>
                    <Input id="url-input" type="url" placeholder="https://linkedin.com/in/your-profile" value={url} onChange={(e) => { setUrl(e.target.value); setFile(null); }} />
                  </div>
                </TabsContent>
              </Tabs>
